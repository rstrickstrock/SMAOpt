REPOSITORY CONTENTS:
 ...
 - surrogateModelTraining/  -> contains the scripts to train the models as presented in the manuscript

 - trainingdata_acquisition -> contains the scripts to create the data used for the surrogate model training
