...
cp $script_path/loadEvalSurrogModel.py $script_path/trainedModel.pth $script_path/modelConfig.csv $sim_cwd
#cp $script_path/trainedModel.pth $sim_cwd/trainedModel.pth
...
#cp $script_path/physprop_eval.py $sim_cwd
#cp $script_path/physprop_eval.sh $sim_cwd
#cp $script_path/physprop_collect.sh $sim_cwd
#cp $script_path/physprop_cleanup.sh $sim_cwd
