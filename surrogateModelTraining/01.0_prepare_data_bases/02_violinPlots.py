...
violin_plot.set_title(f'Dataset: Grid1296', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensityGrid1296_all.png', dpi=100, format='png')

plt.figure()  
violin_plot = sns.violinplot(data=dfResults2401["density"])
violin_plot.set_title(f'Dataset: Grid2401', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensityGrid2401_all.png', dpi=100, format='png')
  
plt.figure()
violin_plot = sns.violinplot(data=dfResultsSobol1["density"])
violin_plot.set_title(f'Dataset: Sobol1', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensitySobol1_all.png', dpi=100, format='png')

plt.figure()
violin_plot = sns.violinplot(data=dfResultsSobol2["density"])
violin_plot.set_title(f'Dataset: Sobol2', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensitySobol2_all.png', dpi=100, format='png')



plt.figure()
violin_plot = sns.violinplot(data=dfCleaned1296["density"])
violin_plot.set_title(f'Dataset: Grid1296 (cleaned)', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensityGrid1296_cleaned.png', dpi=100, format='png')

plt.figure()  
violin_plot = sns.violinplot(data=dfCleaned2401["density"])
violin_plot.set_title(f'Dataset: Grid2401 (cleaned)', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensityGrid2401_cleaned.png', dpi=100, format='png')
  
plt.figure()
violin_plot = sns.violinplot(data=dfCleanedSobol1["density"])
violin_plot.set_title(f'Dataset: Sobol1 (cleaned)', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensitySobol1_cleaned.png', dpi=100, format='png')

plt.figure()
violin_plot = sns.violinplot(data=dfCleanedSobol2["density"])
violin_plot.set_title(f'Dataset: Sobol2 (cleaned)', fontweight='bold')
violin_plot.set_xticklabels([f''])
violin_plot.set_xlabel('Frequency Of Occurrence', fontweight='bold')
violin_plot.set_ylabel('Density [kg/m³]', fontweight='bold')
fig = violin_plot.get_figure()
plt.tight_layout()
if saveOrShow == "save":
  plt.savefig(f'violinplotDensitySobol2_cleaned.png', dpi=100, format='png')
