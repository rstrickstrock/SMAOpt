...
for thisRatio in testSizes:
  ...
  for rndInt in rndInts:
    ...
    for thisKernel in kernels:
      fileGrid1296 = f'trained_modelGrid1296_{thisRatio}_{rndInt}_{thisKernel}.sav'
      ...
      fileGrid2401 = f'trained_modelGrid2401_{thisRatio}_{rndInt}_{thisKernel}.sav'
      ...
      fileSobol1 = f'trained_modelSobol1_{thisRatio}_{rndInt}_{thisKernel}.sav'
      ...
      fileSobol2 = f'trained_modelSobol2_{thisRatio}_{rndInt}_{thisKernel}.sav'
